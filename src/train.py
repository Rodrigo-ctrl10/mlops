...
MLFLOW_TRACKING_DIR = r"D:\parcial_Rodrigo_Hervias\mlruns"
mlflow.set_tracking_uri("file:///" + MLFLOW_TRACKING_DIR.replace("\\", "/"))
mlflow.set_experiment("xgboost_local_experiment")

# -------- Rutas de entrada --------
DATA_DIR = r"D:\parcial_Rodrigo_Hervias\data\processed"
...
with mlflow.start_run(run_name="xgboost_local_run"):
    ...
    # =========================
    OUTPUT_DIR = r"D:\parcial_Rodrigo_Hervias\models"
