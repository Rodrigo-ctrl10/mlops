...
MLFLOW_TRACKING_DIR = r"D:\maestria_data_science\nueva_carpeta\cuarto_ciclo\mlops\mlops_project\trabajo_mlflow"
mlflow.set_tracking_uri("file:///" + MLFLOW_TRACKING_DIR.replace("\\", "/"))
mlflow.set_experiment("xgboost_local_experiment")

# -------- Rutas de entrada --------
DATA_DIR = r"D:\maestria_data_science\nueva_carpeta\cuarto_ciclo\mlops\mlops_project\data\processed"
...
with mlflow.start_run(run_name="xgboost_local_run"):
    ...
    # =========================
    OUTPUT_DIR = r"D:\maestria_data_science\nueva_carpeta\cuarto_ciclo\mlops\mlops_project\models"
